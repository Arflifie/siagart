        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    @if($report->wa_number)
                        <a href="https://wa.me/{{ $report->wa_number }}" target="_blank" class="w-full py-2.5 px-4 bg-green-50 text-green-700 hover:bg-green-100 font-medium rounded-lg flex justify-center gap-2 border border-green-200">
